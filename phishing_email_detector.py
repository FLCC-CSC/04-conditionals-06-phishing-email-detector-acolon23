...
It wasn't completley difficult, however I did have to be cautious of the spelling and
capitalization within my code to make sure it matches the output exactly to trigger the
correct response.
